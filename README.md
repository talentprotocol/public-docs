...
If you're only editing non-autogenerated `.mdx` docs and not running any data point or API generation scripts, you can work locally without a Talent Protocol API key and just preview your changes with `npm run start`.
