...
APIs/SDKs. We may use or offer third-party application program interfaces (“APIs”) and software development kits (“SDKs”) as part of the Services. For more information about our use of APIs and SDKs, please see [https://docs.talent.app/docs](https://docs.talent.app/docs).
